...
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             &kp KP_NUM,        &kp KP_N7,         &kp KP_N8,         &kp KP_N9,         &kp KP_MINUS,      \
&kp LGUI,          &kp LALT,          &kp LSHFT,         &kp LCTRL,         U_NU,              &kp KP_SLASH,      &kp KP_N4,         &kp KP_N5,         &kp KP_N6,         &kp KP_PLUS,       \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             &kp KP_ASTERISK,   &kp KP_N1,         &kp KP_N2,         &kp KP_N3,         &kp KP_ENTER,      \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp KP_N0,         &kp KP_DOT,        U_NP,              U_NP
